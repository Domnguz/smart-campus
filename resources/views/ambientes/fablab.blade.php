{{-- resources/views/ambientes/fablab.blade.php --}}
@extends('layouts.app')
    ...
    <div class="w-full max-w-5xl mx-auto px-4 md:px-8">
        ...
        <div class="bg-white rounded-2xl mt-4 shadow-sm border border-blue-100 grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-blue-100">
            ...
            <div class="px-5 py-6">
                ...
                <p class="text-lg font-bold text-slate-800 mt-1">FAB01</p>
            </div>

            <div class="px-5 py-6">
                <p class="text-xs uppercase tracking-wide text-blue-600 font-semibold">Ubicación</p>
                <p class="text-lg font-bold text-slate-800 mt-1">Pabellón A</p>
            </div>

            <div class="px-5 py-6">
                <p class="text-xs uppercase tracking-wide text-blue-600 font-semibold">Piso</p>
                <p class="text-lg font-bold text-slate-800 mt-1">Tercer Nivel</p>
            </div>

            <div class="px-5 py-6">
                <p class="text-xs uppercase tracking-wide text-blue-600 font-semibold">Capacidad</p>
                <p class="text-lg font-bold text-slate-800 mt-1">20 estudiantes</p>
            </div>
        ...
        <div class="grid md:grid-cols-5 gap-10 mt-12 bg-white rounded-2xl shadow-sm border border-blue-100 p-8 md:p-12">
            ...
            <div class="md:col-span-3">
                ...
                <p class="text-slate-600 leading-8">
                    El FabLab del Instituto de Educación Superior Tecnológico Público
                    CAP. FAP. José Abelardo Quiñones es un espacio de fabricación digital
                    donde los estudiantes desarrollan prototipos y proyectos aplicando
                    tecnologías como impresión 3D, corte láser y diseño asistido por
                    computadora.
                </p>

                <h2 class="text-xl font-bold text-slate-800 mt-10 mb-3">Objetivo</h2>
                <p class="text-slate-600 leading-8">
                    Fomentar la innovación y el pensamiento creativo mediante el uso de
                    herramientas de fabricación digital, permitiendo a los estudiantes
                    convertir sus ideas en prototipos funcionales.
                </p>
            </div>
