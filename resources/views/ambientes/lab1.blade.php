{{-- resources/views/ambientes/lab1.blade.php --}}
@extends('layouts.app')
    ...
    <div class="w-full max-w-5xl mx-auto px-4 md:px-8">
        ...
        <div class="bg-white rounded-2xl mt-4 shadow-sm border border-blue-100 grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-blue-100">
            ...
            <div class="px-5 py-6">
                ...
                <p class="text-lg font-bold text-slate-800 mt-1">LAB1</p>
            </div>
        ...
        <div class="grid md:grid-cols-5 gap-10 mt-12 bg-white rounded-2xl shadow-sm border border-blue-100 p-8 md:p-12">
            ...
            <div class="md:col-span-3">
                ...
                <p class="text-slate-600 leading-8">
                    ...
                    estudiantes fortalecen sus competencias técnicas mediante
                    ejercicios prácticos que complementan la formación teórica
                    impartida en clase.
                </p>
                ...
                <p class="text-slate-600 leading-8">
                    ...
                    de programación, promoviendo el uso de recursos tecnológicos y
                    fortaleciendo el aprendizaje de los estudiantes mediante
