{{-- resources/views/ambientes/lab2.blade.php --}}
@extends('layouts.app')

@section('title', 'Laboratorio 2')
    ...
    <div class="w-full max-w-5xl mx-auto px-4 md:px-8">
        ...
        <div class="bg-white rounded-2xl mt-4 shadow-sm border border-blue-100 grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-blue-100">
            ...
            <div class="px-5 py-6">
                ...
                <p class="text-lg font-bold text-slate-800 mt-1">LAB2</p>
            </div>

            <div class="px-5 py-6">
                <p class="text-xs uppercase tracking-wide text-blue-600 font-semibold">Ubicación</p>
                <p class="text-lg font-bold text-slate-800 mt-1">Edificio A</p>
            </div>

            <div class="px-5 py-6">
                <p class="text-xs uppercase tracking-wide text-blue-600 font-semibold">Piso</p>
                <p class="text-lg font-bold text-slate-800 mt-1">Primer Nivel</p>
            </div>

            <div class="px-5 py-6">
                <p class="text-xs uppercase tracking-wide text-blue-600 font-semibold">Capacidad</p>
                <p class="text-lg font-bold text-slate-800 mt-1">30 estudiantes</p>
            </div>
        ...
        <div class="grid md:grid-cols-5 gap-10 mt-12 bg-white rounded-2xl shadow-sm border border-blue-100 p-8 md:p-12">
            ...
            <div class="md:col-span-3">
                ...
                <p class="text-slate-600 leading-8">
                    El Laboratorio 2 (LAB2) es un ambiente de cómputo del Instituto
                    de Educación Superior Tecnológico Público CAP. FAP. José Abelardo
                    Quiñones, equipado con laptops destinadas a la práctica de
                    programación y desarrollo de software. Su formato portátil
                    permite reorganizar el espacio según la actividad, facilitando
                    tanto el trabajo individual como en equipo.
                </p>

                <h2 class="text-xl font-bold text-slate-800 mt-10 mb-3">Objetivo</h2>
                <p class="text-slate-600 leading-8">
                    Brindar un espacio flexible para el desarrollo de actividades
                    de programación, promoviendo el uso de recursos tecnológicos
                    portátiles y fortaleciendo el aprendizaje colaborativo entre
                    los estudiantes.
                </p>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <ul class="space-y-3">
                    @foreach ([
                        'Laptops para uso académico',
                        'Proyector multimedia',
                        'Pizarra acrílica',
                        'Conexión a internet',
                        'Aire acondicionado',
                        'Mobiliario flexible para trabajo en equipo',
                    ] as $item)
